...
BULK INSERT
	SpecObjRAW
	FROM 'C:\Data\ebanyai\project\Skyquery-data\LAMOST_DR1\\lamost_SpecObj.bin'
	WITH
	(
		DATAFILETYPE = 'native',
		TABLOCK
...
( cx, cy, cz, htmid, obsid, designation, obsdate, lmjd, planid, spid, fiberid, ra, dec, snru, snrg, snrr, snri, snrz, objtype, class, subclass, magtype, mag1, mag2, mag3, mag4, mag5, mag6, mag7, tsource, fibertype, tfrom, t_info, rv, z, z_err)
SELECT c.x AS  cx, c.y AS cy, c.z AS cz, Spherical.htm.FromXyz(c.x,c.y,c.z) AS htmid, obsid, designation, obsdate, lmjd, planid, spid, fiberid, ra, dec, snru, snrg, snrr, snri, snrz, objtype, class, subclass, magtype, mag1, mag2, mag3, mag4, mag5, mag6, mag7, tsource, fibertype, tfrom, t_info, rv, SpecObjRAW.z, z_err
FROM dbo.SpecObjRAW
