-- SUBSAMPLING TABLE 'PhotoObj' ---
 ...
 INSERT [SkyNode_TwoDF_STAT].[dbo].[PhotoObj] WITH (TABLOCKX)
	([objID], [cat], [ra], [dec], [cx], [cy], [cz], [htmid], [zoneid], [bjsel], [prob], [park], [parmu], [igal], [jon], [orient], [eccent], [area], [x_bj], [y_bj], [dx], [dy], [bjg], [rmag], [pmag], [fmag], [smag], [redmag], [ifield], [igfield], [name], [bjg_old], [bjselold], [bjg_100], [bjsel100])
 SELECT sourcetablealias.[objID], sourcetablealias.[cat], sourcetablealias.[ra], sourcetablealias.[dec], sourcetablealias.[cx], sourcetablealias.[cy], sourcetablealias.[cz], sourcetablealias.[htmid], sourcetablealias.[zoneid], sourcetablealias.[bjsel], sourcetablealias.[prob], sourcetablealias.[park], sourcetablealias.[parmu], sourcetablealias.[igal], sourcetablealias.[jon], sourcetablealias.[orient], sourcetablealias.[eccent], sourcetablealias.[area], sourcetablealias.[x_bj], sourcetablealias.[y_bj], sourcetablealias.[dx], sourcetablealias.[dy], sourcetablealias.[bjg], sourcetablealias.[rmag], sourcetablealias.[pmag], sourcetablealias.[fmag], sourcetablealias.[smag], sourcetablealias.[redmag], sourcetablealias.[ifield], sourcetablealias.[igfield], sourcetablealias.[name], sourcetablealias.[bjg_old], sourcetablealias.[bjselold], sourcetablealias.[bjg_100], sourcetablealias.[bjsel100]
