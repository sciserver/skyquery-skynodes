...
CREATE TABLE [dbo].[PhotoPSC](
	...
	--/ <quantity>stat.eror;phot.mag;em.IR.H</quantity>
	--/ <unit>mag</unit>
...
CREATE TABLE [dbo].[PhotoXSC](
	...
	--/ <summary unit="mag/sq. arcsec">J mean surface brightness at the half-light radius.</summary>
	--/ <quantity></quantity>
	...
	--/ <summary unit="mag/sq. arcsec">H mean surface brightness at the half-light radius.</summary>
	--/ <quantity></quantity>
	...
	--/ <summary unit="mag/sq. arcsec">K mean surface brightness at the half-light radius.</summary>
	--/ <quantity></quantity>
	...
	--/ <summary unit="mag/sq. arcsec">J peak pixel brightness.</summary>
	--/ <quantity></quantity>
	[j_peak] [real] NOT NULL, 

	--/ <summary unit="mag/sq. arcsec">H peak pixel brightness.</summary>
	--/ <quantity></quantity>
	[h_peak] [real] NOT NULL, 

	--/ <summary unit="mag/sq. arcsec">K peak pixel brightness.</summary>
	--/ <quantity></quantity>
	[k_peak] [real] NOT NULL, 

	--/ <summary unit="mag/sq. arcsec">J central surface brightness (r&amp;lt;=5).</summary>
	--/ <quantity></quantity>
	[j_5surf] [real] NOT NULL, 

	--/ <summary unit="mag/sq. arcsec">H central surface brightness (r&amp;lt;=5).</summary>
	--/ <quantity></quantity>
	[h_5surf] [real] NOT NULL, 

	--/ <summary unit="mag/sq. arcsec">K central surface brightness (r&amp;lt;=5).</summary>
	--/ <quantity></quantity>
