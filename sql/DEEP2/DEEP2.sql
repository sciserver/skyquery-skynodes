...
BULK INSERT
	PhotoObjRAW
	FROM 'C:\Data\ebanyai\project\Skyquery-data\DEEP2\deep2.bin'
	WITH
	(
		DATAFILETYPE = 'native',
		TABLOCK
...
( cx, cy, cz, htmid, objID, RA, DEC, MAGB, MAGR, MAGI, MAGBERR, MAGRERR, MAGIERR, RG, E2, PA, PGAL, SFD_EBV, M_B, U_B, OBJNAME, MASK, SLIT, DATE, MJD, SLITRA, SLITDEC, SLITLEN, SLITPA, PhotoObjRAW.Z, ZBEST, ZERR, ZQUALITY, CLASS, SUBCLASS, RCHI2, DOF, VDISP, VDISPERR, COMMENT)
SELECT c.x AS  cx, c.y AS cy, c.z AS cz, Spherical.htm.FromXyz(c.x,c.y,c.z) AS htmid, objID, RA, DEC, MAGB, MAGR, MAGI, MAGBERR, MAGRERR, MAGIERR, RG, E2, PA, PGAL, SFD_EBV, M_B, U_B, OBJNAME, MASK, SLIT, DATE, MJD, SLITRA, SLITDEC, SLITLEN, SLITPA, PhotoObjRAW.Z, ZBEST, ZERR, ZQUALITY, CLASS, SUBCLASS, RCHI2, DOF, VDISP, VDISPERR, COMMENT
